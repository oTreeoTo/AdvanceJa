...
public class UpdateBookActivity extends AppCompatActivity implements AdapterView.OnItemClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public void displayListView() {
        MyAdapterUpdateAndDeleteBook adapterBook = new MyAdapterUpdateAndDeleteBook(this,datas);
